...
public class SerialDateTest extends TestCase {
    ...
    public void testAddMonthsTo9Nov2001() {
     ...
     public void testWeekdayCodeToString() {
         ...
         // TODO: 5/1/2021 this function is case sensitive which is not our expected behavior
         final String test2 = SerialDate.weekdayCodeToString(SerialDate.MONDAY);
         assertEquals("monday", test2);
     }
